...
O consignado é uma modalidade de empréstimo onde as parcelas são descontadas diretamente da folha de pagamento ou benefício do tomador. No consignado público, servidores públicos e aposentados do INSS têm acesso a essa linha de crédito, enquanto o privado é voltado para empregados de empresas privadas conveniadas.

Abaixo segue o passo a passo para utilização do caso de uso:

<Warning>Antes de utilizar este serviço, é necessário configurar a autenticação. Consulte as [instruções de autenticação](https://bmpmoneyplus-sandbox.mintlify.app/caas/primeiros-passos/autenticacao) para orientações detalhadas.</Warning>

## 1 - Simulações

Conheça abaixo nossos tipos de simulações:

<Expandable title= "1.1 - Simulação Detalhada">
    Por meio deste endpoint será possível realizar a simulação através da integração com nossa API de [Simulação detalhada](https://bmpmoneyplus-sandbox.mintlify.app/caas/api-reference/simulacoes/6-simulacao-detalhada)
...
Nesta etapa será necessário realizar a simulação através da integração com nossa API de [Simulação Multiparcelamento](https://bmpmoneyplus-sandbox.mintlify.app/caas/api-reference/simulacoes/5-simulacao-multiparcelamento)
...
Nesta etapa será necessário realizar o cadastro do clientes através da integração com nossa API de [Cadastro de Cliente](https://bmpmoneyplus-sandbox.mintlify.app/caas/api-reference/onboarding/10-cadastro-do-cliente)
...
Nesta etapa será necessário realizar o cadastro ou atualização do endereço através da integração com nossa API de [Cadastro de Endereço](https://bmpmoneyplus-sandbox.mintlify.app/caas/api-reference/onboarding/11-cadastro-do-endereco)
...
Nesta etapa será necessário realizar o envio da proposta através da integração com nossa API de [Incluir Proposta](https://bmpmoneyplus-sandbox.mintlify.app/caas/api-reference/contratacao/23-inclusao-com-calculo-externo)
...
<Info>Para conhecer mais sobre nossas assinaturas, suas particularidades e qual utilizar em seu projeto [conheça nosso material explicativo sobre as assinaturas](https://bmpmoneyplus-sandbox.mintlify.app/caas/assinaturas).</Info>
...
Nesta etapa será necessário realizar a assinatura eletrônica através da integração com nossa API de [Assinatura Eletrônica](https://bmpmoneyplus-sandbox.mintlify.app/caas/api-reference/assinaturas/39-eletronica).
...
Nesta etapa será necessário realizar a consulta do CCB através da integração com nossa URL de [Impressão de CCB](https://bmpmoneyplus-sandbox.mintlify.app/caas/api-reference/impressao-documentos/37-impressao-ccb) para realizar a validação do modelo antes da assinatura.
...
Nesta etapa será necessário realizar a assinatura Relogon através da integração com nossa API de [Assinatura Relogon](https://bmpmoneyplus-sandbox.mintlify.app/caas/api-reference/assinaturas/40-relogon).
...
Após o envio da requisição de assinatura Relogon, será necessário finalizar a proposta através da integração com o endpoint de [Finalização de proposta](https://bmpmoneyplus-sandbox.mintlify.app/caas/api-reference/assinaturas/42-finalizacao-de-proposta).
...
Após a coleta das assinaturas, será necessário realizar o upload da CCB assinada, através da integração com nossa API de [Assinatura Certificadora](https://bmpmoneyplus-sandbox.mintlify.app/caas/api-reference/assinaturas/41-certificadora).
...
Nesta etapa será necessário realizar a liberação da proposta através da integração com nossa URL de [Liberação da proposta para pagamento](https://bmpmoneyplus-sandbox.mintlify.app/caas/api-reference/desembolso/43-liberacao-de-proposta) para realizar a validação do modelo após a assinatura.
...
* [Atualização da Conta Bancária](https://bmpmoneyplus-sandbox.mintlify.app/caas/referencias-de-api/desembolso/44-atualizacao-de-conta-bancaria) será utilizado nesta jornada para atualização da conta pagamento. 
* [Procedimento Técnico Callback](https://bmpmoneyplus-sandbox.mintlify.app/caas/procedimento-tecnico-de-callback/eventos) será utilizado nesta jornada para confirmação de assintura e confirmação de pagamento. 
* [Consultar Contrato](https://bmpmoneyplus-sandbox.mintlify.app/caas/referencias-de-api/gestao-de-propostas/28-consultar) será utilizado nesta jornada para consultar os dados da proposta.
* [Consultar comprovante de Pagamento](https://bmpmoneyplus-sandbox.mintlify.app/caas/referencias-de-api/impressao-documentos/38-comprovante-de-pagamento) será utilizado nesta jornada para consultar o comprovante de pagamento da proposta.
* [Cancelamento de Contrato](https://bmpmoneyplus-sandbox.mintlify.app/caas/referencias-de-api/gestao-de-propostas/33-cancelamento-de-contrato#33-cancelamento-de-contrato) será utilizado nesta jornada para cancelamento de contrato.
