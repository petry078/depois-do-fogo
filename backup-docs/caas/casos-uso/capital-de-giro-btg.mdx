---
title: "Capital de Giro com/sem Garantia (Cessão BTG)"
version: 'Português'
---

<Warning>Esse caso de uso é exclusivo para utilização de parceiros com cessão BTG.</Warning>
...
<Expandable title= "Fluxo de Endpoint de Cadastro de Pessoa e Endereço">
...
<Expandable title = "Fluxo de Importação em lote de clientes ou endereços">
...
<Steps title= "Atualização de cadastros">
...
Após realizar a atualização do cadastro do cliente e do endereço, é necessário realizar o upload dos documentos do cliente.

<Warning>Essa etapa é obrigatória para casos de formalização BMP.</Warning>

<Expandable title="Requisição para Inclusão do documento">
...
Para isso, utilize o endpoint abaixo:
...
<Expandable title="Garantia de Bens Móveis, Equipammentos e Outros">
...
É necessário enviar os documentos necessários para a proposta. 

<Note>Os documentos devem estar codificados em Base64.</Note>

Para mais informações sobre este endpoint, acesse o documento de referência [15 - Incluir Documento](https://bmpdocs.moneyp.com.br/caas/referencias-de-api/onboarding/15-incluir-documento).

<Expandable title="Requisição para Envio de Documentos da Proposta">
...
<Warning>O envio do documento DUT para a operação de garantia de veículo é obrigatório.</Warning>
...
Para mais informações sobre este endpoint, acesse o documento de referência [39 - Inclusão Assinatura CCB](https://bmpdocs.moneyp.com.br/caas/referencias-de-api/assinaturas/39-inclusao-assinatura-ccb).
...
Nesta etapa será necessário realizar a consulta do CCB através da integração com nossa URL de [Impressão de CCB](https://bmpdocs.moneyp.com.br/caas/referencias-de-api/impressao-documentos/37-impressao-ccb) para realizar a validação do modelo antes da assinatura.
...
Após a coleta das assinaturas, será necessário realizar o upload da CCB assinada, através da integração com nossa API de [Assinatura Certificadora](https://bmpdocs.moneyp.com.br/caas/referencias-de-api/assinaturas/41-certificadora).
...
Após o envio da requisição de assinatura Relogon, será necessário finalizar a proposta através da integração com o endpoint de [Finalização de proposta](https://bmpdocs.moneyp.com.br/caas/referencias-de-api/assinaturas/42-finalizacao-de-proposta).
...
<Expandable title= "Desembolso financeiro BMP">

Nesta etapa será necessário realizar a liberação da proposta através da integração com nosso endpoint de [Liberação da proposta para pagamento](https://bmpdocs.moneyp.com.br/caas/referencias-de-api/desembolso/43-liberacao-de-proposta) para realizar a validação do modelo após a assinatura.
...
<Expandable title= "Desembolso Parceiro">

Nesta etapa será necessário realizar a alteração do status da proposta para o "Paga" (status 09) através da integração com nosso endpint de [Pagamento](https://bmpdocs.moneyp.com.br/caas/referencias-de-api/desembolso/45-pagar).
