...
<Warning>Para implementar esse serviço é necessário configurar a autenticação do serviço CaaS. Para mais informações, acesse o documento [Instruções de Autenticação](https://bmpdocs.moneyp.com.br/caas/primeiros-passos/autenticacao).</Warning>
...
O primeiro passo para a contratação de crédito na modalidade Empréstimo Pessoal é a simulação.
...
Para a contratação de crédito na modalidade **Empréstimo Pessoal**, é necessário cadastrar os dados e o endereço do cliente que receberá o pagamento.

Essa etapa de cadastro é feita utilizando dois endpoints diferentes `Pessoa/Salvar` para o cadastro dos dados do cliente e `/Pessoa/SalvarEndereco` para o cadastro do endereço do cliente.

<Expandable title="Cadastro dos dados do cliente">
...
<Warning>Ao utilizar esse endpoint, informe o CPF ou o CNPJ no campo `DocumentoFederal`. Ao informar CPF, será considerado apenas o objeto PF. Ao informar CNPJ, será considerado apenas o objeto PJ.</Warning>

</Expandable>

<Expandable title="Cadastro do endereço do cliente">
...
<br />
<br />
Para preenchimento dos campos `tipoEndereco` e `tipoResidencia`, acesse o documento de [Referência de API do endpoint Inclusão com Cálculo Externo](https://bmpdocs.moneyp.com.br/caas/referencias-de-api/contratacao/23-inclusao-com-calculo-externo).
...
Após a simulação e o onboarding, é necessário realizar a requisição de contratação de crédito. Chamamos essa etapa de **Inclusão de Proposta**.
...
Após a simulação, onboarding, e requisição de contratação, é necessário coletar as assinaturas dos envolvidos na proposta.
...
Este é o último passo do processo de contratação do crédito na modalidade **Empréstimo Pessoal**.
