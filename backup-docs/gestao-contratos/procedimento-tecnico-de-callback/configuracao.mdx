...
Para implementar os serviços da **Agenda de Gestão de Contratos**, é necessário que o parceiro configure uma URL para o recebimento dos eventos de callback. 
