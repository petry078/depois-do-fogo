---
title: "42 - Enviar Proposta PJ"
openapi: post /Bureau/B2E/EnviarPropostaPJ
---
...
* `CNPJ`: documento do cliente pessoa jurídica que será submetido à análise de crédito.
...
| Objeto                | Campo                             | Tipo de Dado | Descrição                                                      |
|-----------------------|-----------------------------------|--------------|----------------------------------------------------------------|
| `proponente`          | `RazaoSocial`                     | string       | Razão social da empresa.                                       |
| `proponente`          | `NomeFantasia`                    | string       | Nome fantasia da empresa.                                      |
| `proponente`          | `CNPJ`                            | string       | CNPJ.                                                          |
| `proponente`          | `InscricaoEstadual`               | string       | Inscrição estadual.                                            |
| `proponente`          | `DataFundacao`                    | string/date  | Data da fundação. Formato/Exemplo: 1967-06-17T00:00:00.000Z    |
| `proponente`          | `NumeroFiliais`                   | int          | Número de filiais                                              |
| `proponente`          | `NumeroFuncionarios`              | int          | Número de funcionários                                         |
| `ramoDeAtividade`     | `CodigoCNAE`                      | string       | Código do CNAE.                                                |
| `ramoDeAtividade`     | `Descricao`                       | string       | Descrição do CNAE.                                             |
| `ramoDeAtividade`     | `PrincipalAtividade`              | int          | Identificação de atividade principal. 1 para SIM e 2 para NÃO. |
| `faturamento`         | `Mes`                             | int          | Mês do faturamento.                                            |
| `faturamento`         | `Ano`                             | int          | Ano do faturamento.                                            |
| `faturamento`         | `Valor`                           | number       | Valor faturado no mês.                                         |
| `socioProponentePf`   | `Nome`                            | string       | Nome completo.                                                 |
| `socioProponentePf`   | `CPF`                             | string       | CPF.                                                           |
| `socioProponentePf`   | `RG`                              | string       | RG.                                                            |
| `socioProponentePf`   | `RendaMensal`                     | number       | Renda mensal.                                                  |
| `socioProponentePf`   | `DataNascimento`                  | string/date  | Data de nascimento. Formato/Exemplo: 1967-06-17T00:00:00.000Z. |
| `socioProponentePf`   | `Genero`                          | string       | Ver tabela Gênero.                                             |
| `socioProponentePf`   | `NomeMae`                         | string       | Nome completo da mãe.                                          |
| `patromonioDeclarado` | `Valor`                           | number       | Valor do patrimônio declarado.                                 |
| `patromonioDeclarado` | `PercentualParticipacaoSociedade` | number       | Percentual, somente números.                                   |
| `conjuge`             | `Nome`                            | string       | Nome completo do cônjuge.                                      |
| `conjuge`             | `CPF`                             | string       | CPF do cônjuge. Somente os números (11 dígitos).               |
