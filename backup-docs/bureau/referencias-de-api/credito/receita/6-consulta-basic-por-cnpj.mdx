---
title: 6 - Consulta Basic por CNPJ
openapi: post /Bureau/ConsultarReceitaBasicCNPJ
---

Utilize este endpoint para realizar uma consulta individual, que verifica a situação cadastral fiscal de uma empresa em um relatório centralizado.
