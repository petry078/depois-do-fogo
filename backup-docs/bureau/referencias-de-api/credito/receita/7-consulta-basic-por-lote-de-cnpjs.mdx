---
title: 7 - Consulta Basic por Lote de CNPJs
openapi: post /Bureau/ConsultarReceitaLoteBasicCNPJ
---

Utilize este endpoint para realizar consultas em lote que verificam a situação cadastral fiscal de uma empresa em um relatório centralizado.
